            ...
            <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-3" method="post" action="admin/login">
                ...
                <div class="mb-2 d-flex">
                  <a href="{{ route('social.oauth', 'facebook') }}" type="button" class="btn btn-facebook auth-form-btn flex-grow mr-1">
                    <i class="mdi mdi-facebook mr-2"></i>Facebook
                  </a>
                  <a href="{{ route('social.oauth', 'google') }}" type="button" class="btn btn-google auth-form-btn flex-grow ml-1">
