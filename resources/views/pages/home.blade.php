@extends('layout')
@section('title')
<title>Xử lý ảnh công nghiệp - Camera công nghiệp - Machine Vision</title>
<meta name="description" content="Giải pháp xử lý ảnh công nghiệp tốt nhất với chi phí hợp lý" />
@endsection
@section('content')	
@include('inc.slide')
				...
				<div class="item wow slideInDown">
									<div class="content">
										<div class="wrap-item">
											...
											<h1><b>Liên hệ</b></h1>
											<div class="description">Hãy liên hệ với chúng tôi qua số điện thoại 0909045179 hoặc email gửi về sales@vstech.com.vn</div>
...
<div class="container">
								<div class="mgb-40" style="margin-top: 40px">
									<h1 class="titleCenter "><b>Sản phẩm</b></h1>
									<div class="desc text-center textSer">
										<p>Chúng tôi chuyên cung cấp các sản phẩm camera xử lý ảnh trong công nghiệp.</p>
									</div>
									</div>
								<div class="clr" ></div>
@include('inc.product')
