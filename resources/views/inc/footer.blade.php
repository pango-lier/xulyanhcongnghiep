				...
				<div class="icon">
					...
					<div class="info">
						...
						<p>
							...
							<a href="{{$_footer_youtube_link??''}}" target="_blank"> <i style=" color: red;" class="fa fa-youtube-square" aria-hidden="true"> Youtube</i></a> - <a href="{{$_footer_facebook_link??''}}" target="_blank"> <i style=" color: blue;" class="fa fa-facebook-square" aria-hidden="true"> Facebook</i></a>
				...
				<div class="icon">
					...
					<div class="info">
    					...
    					<p>
							...
							<i style="color: green;" class="fa fa-phone-square" aria-hidden="true"></i>{{$_footer_phone_2??''}}
