        ...
        <div class="second-portion">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-lg-4">
                    <div class="box">
                        <div class="icon">
                            <div class="image" style="background-color:rgb(247, 10, 10) !important"><i
                                    class="fa fa-envelope" aria-hidden="true"></i></div>
                            <div class="info">
                                <h3 class="title" style="color:rgb(0, 0, 0)"> Mail & Website</h3>
                                <p style="color:rgb(0, 0, 0)">
                                    <i style=" color: red;" class="fa fa-envelope" aria-hidden="true"></i>
                                    {{ $_footer_email ?? '' }}
                                    <br>
                                    <br>
                                    <a href="{{ $_footer_youtube_link ?? '' }}" target="_blank"> <i
                                            style=" color: red;" class="fa fa-youtube-square" aria-hidden="true">
                                            Youtube</i></a> - <a href="{{ $_footer_facebook_link ?? '' }}"
                                        target="_blank"> <i style=" color: blue;" class="fa fa-facebook-square"
                                            aria-hidden="true">
                                            Facebook</i></a>
                                </p>
                            </div>
                ...
                <div class="col-xs-12 col-sm-6 col-lg-4">
                    <div class="box">
                        <div class="icon">
                            <div class="image" style="background-color:rgb(85, 247, 10) !important"><i
                                    class="fa fa-phone" aria-hidden="true"></i></div>
                            <div class="info">
                                <h3 class="title" style="color:rgb(0, 0, 0)">Điện thoại liên hệ</h3>
                                <p style="color:rgb(0, 0, 0)">
                                    <i style="color: green;" class="fa fa-phone-square" aria-hidden="true">
                                    </i>{{ $_footer_phone_1 ?? '' }}
                                    <br>
                                    <br>
                                    <i style="color: green;" class="fa fa-phone-square" aria-hidden="true">
                ...
                <div class="col-xs-12 col-sm-6 col-lg-4">
                    <div class="box">
                        <div class="icon">
                            ...
                            <div class="image" style="background-color:rgb(10, 113, 247) !important"><i
                                    class="fa fa-map-marker" aria-hidden="true"></i></div>
                            <div class="info">
                                <h3 class="title" style="color:rgb(0, 0, 0)">Địa chỉ</h3>
                                <p style="color:rgb(0, 0, 0)">
                                    <i style="color: red;" class="fa fa-map-marker mr-1" aria-hidden="true">
