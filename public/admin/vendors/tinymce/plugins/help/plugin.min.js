! function() {
    ...
    h("3", tinymce.util.Tools.resolve), g("1", ["3"], function(a) {
    ...
    }), h("f", Array), h("g", Error), g("b", ["f", "g"], function(a, b) {
        var c = function() {},
            d = function(a, b) {
                return function() {
    ...
    }), h("j", Object), g("e", ["b", "j"], function(a, b) {
        var c = a.never,
            d = a.always,
            e = function() {
                return f
    ...
    }), h("h", String), g("8", ["e", "f", "g", "h"], function(a, b, c, d) {
        var e = function() {
        ...
        var c = function() {
            var c = function(a) {
                ...
                d = a.map(b.shortcuts, function(a) {
                    return '<tr data-mce-tabstop="1" tabindex="-1" ' + c(a) + "><td>" + a.action + "</td><td>" + a.shortcut + "</td></tr>"
                }).join("");
            return {
                ...
                items: [{
                    type: "container",
                    html: '<div><table class="mce-table-striped"><thead><th>Action</th><th>Shortcut</th></thead>' + d + "</table></div>"
                }]
            }
        };
        return {
        ...
        var a = ["advlist", "anchor", "autolink", "autoresize", "autosave", "bbcode", "charmap", "code", "codesample", "colorpicker", "compat3x", "contextmenu", "directionality", "emoticons", "fullpage", "fullscreen", "hr", "image", "imagetools", "importcss", "insertdatetime", "legacyoutput", "link", "lists", "media", "nonbreaking", "noneditable", "pagebreak", "paste", "preview", "print", "save", "searchreplace", "spellchecker", "tabfocus", "table", "template", "textcolor", "textpattern", "toc", "visualblocks", "visualchars", "wordcount"];
        return {
            urls: a
        }
    }), g("6", ["4", "a", "8", "b", "c", "d"], function(a, b, c, d, e, f) {
        var g = function(a) {
                return c.find(f.urls, function(b) {
                    return b === a
            ...
            i = function(a) {
                return {
                    type: "container",
                    html: '<div style="overflow-y: auto; overflow-x: hidden; max-height: 230px; height: 230px;" data-mce-tabstop="1" tabindex="-1">' + h(a) + "</div>",
                    flex: 1
                }
            },
            j = function() {
        ...
        var c = function(a, c) {
            a.addButton("help", {
                ...
                context: "view",
                onclick: b.openDialog(a, c)
            }), a.addCommand("mceHelp", b.openDialog(a, c)), a.shortcuts.add("Alt+0", "Open help dialog", b.openDialog(a, c))
        };
        return a.add("help", c),
            function() {}
    }), d("0")()
