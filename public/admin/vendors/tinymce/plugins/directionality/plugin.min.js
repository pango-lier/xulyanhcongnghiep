    ...
    h("3", tinymce.util.Tools.resolve), g("1", ["3"], function(a) {
        ...
        return a.add("directionality", function(a) {
                function c(c) {
                    ...
                    f.length && (d = e.getAttrib(f[0], "dir"), b.each(f, function(a) {
                        e.getParent(a.parentNode, "*[dir='" + c + "']", e.getRoot()) || (d != c ? e.setAttrib(a, "dir", c) : e.setAttrib(a, "dir", null))
                    }), a.nodeChanged())
                }

                function d(a) {
                    var c = [];
                    return b.each("h1 h2 h3 h4 h5 h6 div p".split(" "), function(b) {
                        c.push(b + "[dir=" + a + "]")
                    }), c.join(",")
                }
