! function() {
    ...
    h("6", tinymce.util.Tools.resolve), g("1", ["6"], function(a) {
    ...
    }), h("8", Array), h("9", Error), g("b", ["8", "9"], function(a, b) {
        var c = function() {},
            d = function(a, b) {
                return function() {
    ...
    }), h("h", Object), g("7", ["b", "h"], function(a, b) {
        var c = a.never,
            d = a.always,
            e = function() {
                return f
    ...
    }), h("a", String), g("3", ["7", "8", "9", "a"], function(a, b, c, d) {
        var e = function() {
    ...
    }), h("d", document), g("4", ["b", "9", "c", "d"], function(a, b, c, d) {
        var e = function(a, b) {
                var e = b || d,
        ...
        return a.add("visualchars", function(a) {
                var c, d = this,
                    f = function() {
                        var b = this;
                ...
                a.settings.forced_root_block !== !1 && a.on("keydown", function(b) {
                    d.state === !0 && (13 === b.keyCode ? e.toggle(a) : g())
                }), a.addCommand("mceVisualChars", function() {
                    var b, f = a.getBody(),
                        g = a.selection;
                    c = !c, d.state = c, a.fire("VisualChars", {
                        state: c
                    }), b = g.getBookmark(), c === !0 ? e.show(a, f) : e.hide(a, f), g.moveToBookmark(b)
