! function() {
    ...
    h("3", tinymce.util.Tools.resolve), g("1", ["3"], function(a) {
        ...
        var c = a.DOM;
        return b.add("fullscreen", function(a) {
                function b() {
                    var a, b, c = window,
                        d = document,
                        e = d.body;
