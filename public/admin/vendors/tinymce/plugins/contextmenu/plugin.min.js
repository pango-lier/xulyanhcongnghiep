! function() {
    ...
    h("7", tinymce.util.Tools.resolve), g("1", ["7"], function(a) {
        ...
        var g = a.DOM;
        return c.add("contextmenu", function(a) {
                var c, h, i = a.settings.contextmenu_never_use_native,
                    j = function(a) {
                        return a.ctrlKey && !i
                    },
                    k = function() {
                ...
                return a.on("mousedown", function(b) {
                    ...
                    var f;
                    if (!j(b)) {
                        if (n(b, a.selection.getRng()) && a.selection.select(b.target), b.preventDefault(), f = a.settings.contextmenu || "link openlink image inserttable | cell row column deletetable", c) c.show();
                        else {
                            var i = [];
                            ...
                            for (var k = 0; k < i.length; k++) "|" == i[k].text && (0 !== k && k != i.length - 1 || i.splice(k, 1));
                            c = new d({
                                items: i,
                                context: "contextmenu",
                                classes: "contextmenu"
                            }).renderTo(), c.on("hide", function(a) {
                                a.control === this && (h = !1)
                        ...
                        a.inline || (l = g.getPos(a.getContentAreaContainer()), l.x += b.clientX, l.y += b.clientY), c.moveTo(l.x, l.y), h = !0
                    }
                }), {
